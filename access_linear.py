...
w_labor_15 = net.aggregate(1250, type="sum", decay="linear", name="labor")


w_jobs_15 = net.aggregate(1250, type="sum", decay="linear", name="jobs")
print "30"

w_jobs_30 = net.aggregate(2500, type="sum", decay="linear", name="jobs")
w_labor_30 = net.aggregate(2500, type="sum", decay="linear", name="labor")
print "45"

w_jobs_45 = net.aggregate(3200, type="sum", decay="linear", name="jobs")

w_labor_45 = net.aggregate(3200, type="sum", decay="linear", name="labor")

b_jobs_45 = net.aggregate(7000, type="sum", decay="linear", name="jobs")

b_labor_45 = net.aggregate(7000, type="sum", decay="linear", name="labor")
...
access.to_csv('output/accessibility_linear.csv')
...
test2.to_file('output/dmv_accessibility_linear.shp')
