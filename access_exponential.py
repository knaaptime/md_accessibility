...
w_labor_15 = net.aggregate(1250, type="sum", decay="exponential", name="labor")


w_jobs_15 = net.aggregate(1250, type="sum", decay="exponential", name="jobs")

print "30 min"

w_jobs_30 = net.aggregate(2500, type="sum", decay="exponential", name="jobs")
w_labor_30 = net.aggregate(2500, type="sum", decay="exponential", name="labor")

print "45 min walk and bike"

w_jobs_45 = net.aggregate(3200, type="sum", decay="exponential", name="jobs")

w_labor_45 = net.aggregate(3200, type="sum", decay="exponential", name="labor")

b_jobs_45 = net.aggregate(7000, type="sum", decay="exponential", name="jobs")

b_labor_45 = net.aggregate(7000, type="sum", decay="exponential", name="labor")
...
access.to_csv('output/accessibility_exponential.csv')
...
test2.to_file('output/dmv_accessibility_exponential.shp')
